...
from active_critic.server.analyze import run_eval, run_eval_stats, run_eval_stats_demos, run_eval_stats_pp
...
if __name__ == '__main__':
    ...
    run_eval_stats_pp(device=args.device, weight_decay=args.wd)